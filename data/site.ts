...
export const siteConfig = {
  ...
  positioning: "特种纸业供应链专业服务商",
  description:
    "仙麗科技是一家专注特种纸业供应链服务的企业，以专业背景纸为核心优势品类，连接优质纸品资源、智能化加工能力与全国渠道市场。",
  contact: {
    phone: "请后期填写",
    wechat: "请后期填写",
    email: "请后期填写",
  ...
  routes: [
    {
      path: "/",
      label: "首页",
      title: "仙麗科技｜特种纸业供应链专业服务商｜专业背景纸与纸品批发合作",
      description:
    ...
    },
    {
      path: "/products",
      label: "产品中心",
      title: "产品中心｜专业背景纸、精品包装纸、特种卡纸、文具封面纸",
      description:
        "仙麗科技产品中心覆盖专业背景纸、精品包装纸、特种卡纸、文具封面纸等特种纸品供应。",
      priority: 0.9,
    },
    {
    ...
    },
    {
      ...
      description:
        "展会客户快速了解仙麗科技专业背景纸、特种纸品供应链、标准化品控与渠道合作支持。",
      priority: 0.7,
    },
    {
      path: "/contact",
