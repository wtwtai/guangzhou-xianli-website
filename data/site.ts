  ...
  routes: [
    {
      path: "/",
      label: "首页",
      title: "仙麗科技｜彩卡特种纸供应链专业服务商｜彩卡特种纸与纸品批发合作",
      description:
        "仙麗科技深耕彩卡特种纸全链，依托自有产能、先进设备、ISO 国际认证及 FSC、PEFC 森林认证，为渠道客户提供彩卡特种纸供应链解决方案。",
      priority: 1,
    },
    {
      path: "/about",
      label: "关于仙麗",
      title: "关于仙麗｜彩卡特种纸供应链专业服务商",
      description:
        "了解仙麗科技在彩卡特种纸供应链、自有产能、先进设备、认证体系、标准化品控与渠道合作方面的能力。",
      priority: 0.8,
    },
    {
      path: "/backdrop-paper",
      ...
      description:
        "仙麗科技提供专业背景纸标准化产品方案，服务摄影棚、电商拍摄、内容创作与渠道批发客户。",
      priority: 0.9,
    },
    {
      path: "/products",
      ...
      description:
        "仙麗科技产品中心覆盖彩卡特种纸、专业背景纸、精品包装纸、文具封面纸等特种纸品供应。",
      priority: 0.9,
    },
    {
    ...
    },
    {
      ...
      description:
        "仙麗科技持续完善纸品环保检测、ISO 质量体系认证、FSC 与 PEFC 森林认证资料，为客户提供更可靠的采购依据。",
      priority: 0.75,
    },
    {
      ...
      description:
        "仙麗科技面向全国经销商、批发商、摄影器材渠道、文具渠道与电商卖家招募彩卡特种纸供应链合作伙伴。",
      priority: 0.95,
    },
    {
      path: "/resources",
      ...
      description:
        "获取仙麗科技公司介绍、彩卡特种纸产品目录、背景纸规格表、色卡、渠道合作说明与环保认证资料。",
      priority: 0.7,
    },
    {
      path: "/expo",
      ...
      description:
        "展会客户快速了解仙麗科技彩卡特种纸供应链、专业背景纸、标准化品控与渠道合作支持。",
      priority: 0.7,
    },
    {
      path: "/contact",
